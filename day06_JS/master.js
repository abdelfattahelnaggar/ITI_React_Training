...
function addOper() {
  ...
  if (firstNum == "" || secondNum == "") {
    window.alert("Ensure that you enter number to each field");
  } else {
...
function multOper() {
  ...
  if (firstNum == "" || secondNum == "") {
    ...
    var addResult = `${firstNum} x ${secondNum} = ${firstNum * secondNum}`;
    document.getElementById("multResult").innerHTML = addResult;
  }
}
